package com.pdt.android_gis.ui;
...
public class ColorPickerDialog extends Dialog {
   ...
   private class ColorPickerView extends View {
       ...
       private float x0 = 110;
       private float y0 = 40;
       private float signle = 0.0f;
...
//           Log.v(TAG, "X, 坐标: " + event.getX());
           float y = event.getY() - mHeight / 2 + 50;
//           Log.v(TAG, "Y, 坐标: " + event.getY());
           
           float xi = event.getX();
           float yi = event.getY();
//           if()
           signle = (float) (180*Math.atan((y0-yi) / (xi-x0)) / Math.PI);
           Log.v(TAG, "角度: " + signle);
